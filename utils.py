...
PIPE_SDCC = StableDiffusionControlNetPipeline.from_pretrained(
    "/mnt/disk3/Models/stable-diffusion-v1-5", controlnet=ControlNetModel.from_pretrained("/mnt/disk3/Models/sd-controlnet-canny", torch_dtype=torch.float16), torch_dtype=torch.float16
).to(DEVICE)
